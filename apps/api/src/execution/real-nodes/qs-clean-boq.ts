 ...
 *
 * Accepts the BOQDocument from qs.read_boq and outputs both the
 * full boq object and a flat clean_items array for backwards-compatibility.
 *
 * Sprint 9 (pass-through with optional cleaning)
 */
